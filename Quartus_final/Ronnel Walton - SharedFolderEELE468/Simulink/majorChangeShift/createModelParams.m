...
%--------------------------------------------------------------------------
modelParams.audio.fractionLength  = 16;     % fraction size of audio signal
modelParams.audio.wordLength      = 8 + modelParams.audio.fractionLength;     % word size of audio signal
...
modelParams.buffer_size = fi((2^modelParams.dpramAddressSize),1,modelParams.audio.wordLength, modelParams.audio.fractionLength);
